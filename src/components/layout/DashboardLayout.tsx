            ...
            <div className="space-y-0.5 lg:space-y-1">
              <Link
                ...
                className={cn(
                  ...
                  isActive(ROUTES.LOCATIONS) || pathname.startsWith('/locations/')
              ...
              <Link
                href={ROUTES.DEVICE_HUB}
                onClick={closeMobileMenu}
                className={cn(
                  'w-full flex items-center rounded-lg transition-colors',
                  isCollapsed ? 'justify-center px-3 py-2' : 'gap-2.5 lg:gap-3 px-3 lg:px-4 py-2',
                  isActive(ROUTES.DEVICE_HUB) || pathname.startsWith('/devices/')
                    ? 'bg-primary/20 text-primary'
                    : 'text-text-secondary hover:bg-card-hover dark:hover:bg-white/10 hover:text-text-primary'
                )}
              ...
              <Link
                ...
                className={cn(
                  'w-full flex items-center rounded-lg transition-colors',
                  isCollapsed ? 'justify-center px-3 py-2' : 'gap-2.5 lg:gap-3 px-3 lg:px-4 py-2',
                  isActive(ROUTES.TEAM_MANAGEMENT) || pathname.startsWith('/team/')
                    ? 'bg-primary/20 text-primary'
                    : 'text-text-secondary hover:bg-card-hover dark:hover:bg-white/10 hover:text-text-primary'
                )}
